			...
			success: function(data){
				...
				$.each(data._data, function(key, ar){
					...
					$('.file-manager > .lastfiles').append('<div class="file-line" id="'+ar.uniq+'">'+
							...
							'<div class="line-info"><i class="glyphicon glyphicon-info-sign" rel="tooltip" title="'+lng.added+': '+ar.login+' | '+lng.date+': '+ar.date+'"></i></div>'+
							'<div class="line-act"><a href="#" rel="tooltip" title="'+lng.delete+'" class="file-remove glyphicon glyphicon-remove-sign"></a></div>'+
						'</div>');
