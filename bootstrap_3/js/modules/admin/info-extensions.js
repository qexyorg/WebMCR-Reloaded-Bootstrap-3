		...
		success: function(json){
			...
			if(json.type=='success'){
				...
				for(var i = 0; i < len; i++){
					...
					$(".adm-info-modules .thumbnails").append('<li class="col-md-4"><div class="thumbnail"><img src="'
						+ ar.img + '" alt="img"><div class="title">'
						+ ar.title + '</div><div class="read-more"><a href="'
						+ ar.url.full + '" class="btn btn-block btn-default" target="_blank">'+lng_ie.readmore+'</a></div><div class="get-link"><a href="'
